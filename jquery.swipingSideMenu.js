            ...
            Plugin.prototype.dragging = function () {
                ...
                element
                    ...
                    .on('touchend', function () {
                        ...
                        if ((+new Date() - touchStartDate) <= self.settings.swipeToggleDuration && (Math.abs(currentPointer.x - startPointer.x)) >= self.settings.swipeToggleDistance) {
                           element.trigger('toggle.swipingSideMenu');
                        } else {
